Feature: Example
  ...
  Scenario: Assert contain text
    ...
    And I set Email with text mervindiazlugo@gmail.com
    And I do a click in element Confirmacion_Email
    Then Assert if Email error contains text This email is already connected
    Then Assert if Email error is equals to This email is already connected to an account. Log in.
  ...
  Scenario: Elements is/is not present
    ...
    And I set Email with text mervindiazlugo@gmail.com
    And I do a click in element Confirmacion_Email
    Then Check if Email error is Displayed
